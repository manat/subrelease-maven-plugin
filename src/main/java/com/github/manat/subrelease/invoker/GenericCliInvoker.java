...
/**
 * An implementation of @{InvokerProxy}, using maven-embedder (aka maven cli).
 */
public class GenericCliInvoker extends AbstractInvoker {

    private String projectDir;

    private MavenCli cli;

    public GenericCliInvoker(String projectDir) {
    ...
    public boolean execute(String[] commands, String... options) {
        ...
        int result = cli
                .doMain(args.toArray(new String[0]), projectDir, System.out,
                        System.err);
